...
if($_POST['display_PROJET']){
    ...
    if($check){
        $req = $bdd->query("SELECT * FROM PROJET WHERE NOM = '".$NOM."' OR DEPARTEMENT = '".$DEPARTEMENT."' OR 
            CHEF = '".$CHEF."' OR BUDGET = '".$BUDGET."' OR DATE_DEBUT = '".$DATE_DEBUT."' OR COUT = '".$COUT."' OR DATE_FIN = '".$DATE_FIN."'  ");
