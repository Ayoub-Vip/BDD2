...
CREATE TABLE EVALUATION(
     PROJET       VARCHAR(15) NOT NULL PRIMARY KEY
    ,EXPERT       INTEGER  NOT NULL
    ,COMMENTAIRES VARCHAR(800) NOT NULL
...
CREATE TABLE RAPPORT(
     EMPLOYE INTEGER  NOT NULL
    ,PROJET  VARCHAR(15) NOT NULL
    ,TITRE   VARCHAR(35) NOT NULL PRIMARY KEY
...
CREATE TABLE MOTS_CLES(
   RAPPORT VARCHAR(35) NOT NULL
  ,MOT_CLE VARCHAR(20) NOT NULL
